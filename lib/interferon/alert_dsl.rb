...
module Interferon
  ...
  class AlertDSL
    ...
    def thresholds(v = nil)
      @thresholds ||= ThresholdsDSL.new(@hostinfo)
    end
  ...
  class ThresholdsDSL
    ...
    def ok(v = nil, &block)
      get_or_set(:@ok, v, block, nil)
    end

    def warning(v = nil, &block)
      get_or_set(:@warning, v, block, nil)
    end

    def critical(v = nil, &block)
      get_or_set(:@critical, v, block, nil)
    end
  end
